...
if ( ! function_exists('bk_setup') ) {
	function bk_setup() {
		...
		// bk cannot support extra-wide blocks
...
add_action('init', 'bk_setup');

if ( ! function_exists( 'bk_avatar_attributes' ) ) {
	function bk_avatar_attributes($avatar_attributes) {
...
add_filter('get_avatar','bk_avatar_attributes');

if ( ! function_exists( 'bk_author_avatar' ) ) {
	function bk_author_avatar() {

		echo get_avatar('', $size = '96');
	}
}

if ( ! function_exists( 'bk_author_description' ) ) {
	function bk_author_description() {
		echo get_the_author_meta('user_description');
	}
}

if ( ! function_exists( 'bk_post_date' ) ) {
	function bk_post_date() {
